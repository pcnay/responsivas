          ...
          <div class="box-body">
            ...
            <!-- Clases de BootStrap para las formularios-->
            	...
            	<div class="form-group">
	              ...
	              <div class = "input-group">
	                <span class="input-group-addon"><i class="fa fa-code"></i></span>
	                <input type="text" maxlength="25" class="form-control input-lg" id = "nuevoNumTel" name="nuevoNumTel" placeholder = "Ingresar Numero Telefonico">
	              </div> <!-- <div class = "input-group"> -->           
							</div> <!-- <div class="form-group"> -->
            </div>  <!-- class= "col-xs-12 col-sm-6"> -->
            ...
            <!-- Clases de BootStrap para las formularios-->
            	...
            	<div class="form-group">
	              ...
	              <div class = "input-group">
	                <span class="input-group-addon"><i class="fa fa-code"></i></span>
	                <input type="text" maxlength="45" class="form-control input-lg" id = "nuevaCuenta" name="nuevaCuenta" placeholder = "Num. Cuenta ">
	              </div> <!-- <div class = "input-group"> -->           
							</div> <!-- <div class="form-group"> -->
            </div>  <!-- class= "col-xs-12 col-sm-6"> -->
            ...
            <!-- Clases de BootStrap para las formularios-->
            	...
            	<div class="form-group">
	              ...
	              <div class = "input-group">
	                <span class="input-group-addon"><i class="fa fa-code"></i></span>
	                <input type="text" maxlength="20" class="form-control input-lg" id = "nuevaDireccMac" name="nuevaDireccMac" placeholder = "MAC Address Tel ">
	              </div> <!-- <div class = "input-group"> -->           
							</div> <!-- <div class="form-group"> -->
            </div>  <!-- class= "col-xs-12 col-sm-6"> -->
            ...
            <!-- Clases de BootStrap para las formularios-->
            	...
            	<div class="form-group">
	              ...
	              <div class = "input-group">
	                <span class="input-group-addon"><i class="fa fa-code"></i></span>
	                <input type="text" maxlength="30" class="form-control input-lg" id = "nuevoImei" name="nuevoImei" placeholder = "IMEI Tel">
	              </div> <!-- <div class = "input-group"> -->           
							</div> <!-- <div class="form-group"> -->
            </div>  <!-- class= "col-xs-12 col-sm-6"> -->
