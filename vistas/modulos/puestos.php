          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class = "input-group">
                ...
                <input type="text" maxlength="100" class="form-control input-lg" name="nuevoPuesto" placeholder = "Ingresar Puesto" id="nuevoPuesto" required>
        ...
        <div class="modal-body">
          <div class="box-body">
            ...
            <div class="form-group">
              <div class = "input-group">
                <span class="input-group-addon"><i class="fa fa-th"></i></span>
                <input type="text" maxlength="100" class="form-control input-lg" name="editarPuesto"  id="editarPuesto" required>
