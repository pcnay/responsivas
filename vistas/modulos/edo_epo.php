    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-body">
          <div class="box-body">
            ...
            <div class="form-group">
              <div class = "input-group">
                <span class="input-group-addon"><i class="fa fa-th"></i></span>
                <input type="text" class="form-control input-lg" name="editarEdo_Epo"  id="editarEdo_Epo" required>
								<!-- Se envía como campo oculto para enviar el "id" del Estado Equipo -->
								<input type="hidden"  name="idEdo_Epo"  id="idEdo_Epo" required>
              </div> <!-- <div class = "input-group"> -->           
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Salir</button>
            <button type="submit" class="btn btn-primary">Editar Edo Epo</button>
          </div>

					<?php 
						// Para grabar la modifiacion de Estado De Equipo.
						$editarEdo_Epo = new ControladorEdo_Epos();
						$editarEdo_Epo->ctrEditarEdo_Epo();
					?>
...
<?php 
	// =====================================================
	// Para borrar un Estado De Equipo.
	// =====================================================
	// Cuando se accese a este archivo, se esta ejecutando permanentemente.
	$borrarEdo_Epo = new ControladorEdo_Epos();
	$borrarEdo_Epo->ctrBorrarEdo_Epo();
