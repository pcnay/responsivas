...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini login-page">
  ...
  <?php
    ...
    if (isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok")
    {
      ...
      echo '<div class="wrapper">';
        ...
        {
					print_r($_GET["ruta"]);
          if ($_GET["ruta"]=="inicio" || $_GET["ruta"]=="usuarios" || $_GET["ruta"]=="perifericos" || $_GET["ruta"]=="productos" || $_GET["ruta"]=="clientes"|| $_GET["ruta"]=="ventas" || $_GET["ruta"]=="crear-venta" || $_GET["ruta"]=="editar-venta" || $_GET["ruta"]=="marcas" ||  $_GET["ruta"]=="Modelos" || $_GET["ruta"]=="ubicaciones" ||  $_GET["ruta"]=="supervisores" || $_GET["ruta"]=="puestos" || $_GET["ruta"]=="deptos" || $_GET["ruta"]=="empleados" || $_GET["ruta"]=="reportes" || $_GET["ruta"]=="respaldo_bd" || $_GET["ruta"]=="edo-epo" || $_GET["ruta"]=="almacen" || $_GET["ruta"]=="puerto" || $_GET["ruta"]=="patchpanel" || $_GET["ruta"]=="idf"|| $_GET["ruta"]=="cintas" || $_GET["ruta"]=="cap-responsiva" || $_GET["ruta"]=="centro-costos" ||$_GET["ruta"]=="salir")
          {
  ...
  ?>
	...
	<!-- Se muestra el Puerto -->
	<script src="vistas/js/puerto.js"></script>
	<!-- Se muestra el PatchPanel -->
	<script src="vistas/js/patchpanel.js"></script>
	<!-- Se muestra el IDF -->
