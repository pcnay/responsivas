			 ...
			 $datosJson = '{
				...
				for ($i =0;$i<count($responsivas);$i++)
				{
					...
					*/
					...
					{
						$botones = "<div class='btn-group'><button class='btn btn-info btnEditarResponsiva' idResponsiva = '".$responsiva[$i]["id_responsiva"]."' data-toggle='modal' data-target = '#modalEditarResponsiva'><i class='fa fa-print'></i></button><button class='btn btn-warning btnEditarResponsiva' idResponsiva = '".$responsiva[$i]["id_responsiva"]."' data-toggle='modal' data-target = '#modalEditarResponsiva'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarResponsiva' idResponsiva = '".$responsivas[$i]["id_responsiva"]."'><i class='fa fa-times'></i></button></div>";
					...
					else
					{
						...
						//$botones = "<div class='btn-group'><button class='btn btn-warning btnEditarResponsiva' idResponsivao='".$responsivas[$i]["id_responsiva"]."' data-toggle='modal' data-target='#modalEditarResponsiva'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarResponsiva' idResponsiva='".$responsivas[$i]["id_responsiva"]."' imagen='".$responsivas[$i]["Imagen"]."' ><i class='fa fa-times'></i></button></div>";
					}					
