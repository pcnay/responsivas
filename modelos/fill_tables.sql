...
INSERT INTO t_Productos (id_producto,id_almacen,id_edo_epo,id_marca,id_modelo,id_periferico,id_empleado,id_telefonia,id_plan_tel,num_tel,cuenta,nomenclatura,num_serie,imagen_producto,stock,precio_compra,precio_venta,cuantas_veces,asignado,fecha_arribo,comentarios) VALUES
  (0,1,1,1,1,1,1,1,1,'num_telUno','CuentaUno','NomenclaturaUno','numSerieUno','imagenProductoUno','0','10.20','15.20',3,'N',CURRENT_TIMESTAMP,'ComentariosUno'),
  (0,1,1,1,1,1,1,1,1,'num_telDos','CuentaDos','NomenclaturaDos','numSerieDos','imagenProductoDos','0','10.20','15.20',3,'N',CURRENT_TIMESTAMP,'ComentariosDos'),
	(0,1,1,1,1,1,1,1,1,'num_telTres','CuentaTres','NomenclaturaTres','numSerieTres','imagenProductoTres','0','10.20','15.20',3,'N',CURRENT_TIMESTAMP,'Comentari,CURRENT_TIMESTAMPosTres');
